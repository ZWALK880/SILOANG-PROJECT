...
public class FiturPembelian extends javax.swing.JPanel {
            ...
            try (PreparedStatement st = conn.prepareStatement(sql)){
                ResultSet rs = st.executeQuery();
                 ...
                 while (rs.next()) {
                    ...
                    Object[] rowData = {idPembelian, idProduk, namaProduk, jumlahBeli, subtotal, statusPembayaran};
                    model.addRow(rowData);
                }
            }
        } catch (SQLException e) {
        ...
        try {
            ...
            try (PreparedStatement st = conn.prepareStatement(sql)){
                ...
                while (rs.next()) {
                    ...
                    String hargaBeli           = rs.getString("harga");
                    String jumlahBeli          = rs.getString("jumlah_beli");
                    String subtotal            = rs.getString("subtotal");
                    
                    Object[] rowData = {idProduk, namaProduk, satuanProduk, hargaBeli, jumlahBeli, subtotal};
                    model.addRow(rowData);
                }
            }
        } catch (SQLException e) {
    ...
    private void insertDataSementara() {
        ...
        if(idProduk.isEmpty() || namaProduk.isEmpty() || satuanProduk.isEmpty() || hargaBeli.isEmpty() || jumlahBeli.isEmpty() || subtotal.isEmpty() || statusBayar.isEmpty()) {
    ...
    private void insertData() {
        ...
        if(cekIdSupplier(idSupplier)) {
            try {
                String sql = "INSERT INTO pembelian (id_pembelian, total_beli, total_harga, tanggal_transaksi, id_supplier, id_user) VALUES (?,?,?,?,?,?)";
                PreparedStatement st = conn.prepareStatement(sql);
